module.exports = {
    levels: {
        ...
        'libs/bem-core/touch.blocks': {scheme: 'nested'},
        'libs/bem-components/common.blocks': {scheme: 'nested'},
        'libs/bem-components/desktop.blocks': {scheme: 'nested'},
        'libs/bem-components/touch.blocks': {scheme: 'nested'},
        'libs/bem-components/touch-pad.blocks': {scheme: 'nested'},
        'libs/bem-components/touch-phone.blocks': {scheme: 'nested'},
